  ...
  const mainServices = [
    {
      ...
      description: 'Get personalized fashion recommendations from our expert stylists based on your body type, preferences, and occasion.',
    ...
    },
    {
      ...
      icon: '🚚',
      title: 'Fast Delivery',
      description: 'Enjoy quick and reliable delivery services with multiple shipping options to suit your needs.',
    ...
    },
    {
      ...
      icon: '↩️',
      title: 'Easy Returns',
      description: 'Hassle-free return policy with quick refunds and exchanges to ensure complete customer satisfaction.',
      features: ['30-Day Return Window', 'Free Return Shipping', 'Instant Refunds', 'Size Exchange']
    }
  ];
  ...
  const premiumServices = [
    {
      ...
      price: '$99/month',
      description: 'Dedicated personal shopper service with exclusive access to new collections.',
      benefits: ['Priority Access', 'Personal Shopper', 'Early Releases', 'Private Fitting Room']
    },
    {
      id: 2,
      title: 'Wardrobe Revamp',
      price: '$199/session',
      description: 'Complete wardrobe makeover with professional stylists and personalized recommendations.',
      benefits: ['Style Assessment', 'Closet Audit', 'Shopping List', 'Seasonal Planning']
    }
  ];
  ...
  const processSteps = [
    {
      step: 1,
      title: 'Browse & Select',
      description: 'Explore our curated collections and select your favorite items',
      icon: '👕'
    },
    {
      step: 2,
  ...
  const testimonials = [
    {
      ...
      comment: 'The personal styling service completely transformed my wardrobe! I feel more confident than ever.',
      rating: 5,
    ...
    },
    {
      ...
      comment: 'As a VIP member, I get first access to all new collections. Absolutely worth it!',
      rating: 5,
    ...
    },
    {
      ...
      comment: 'The wardrobe revamp service helped me declutter and build a capsule wardrobe I love.',
      rating: 4,
    ...
    },
    {
      ...
      comment: 'Same-day delivery saved me for an important event. Excellent service!',
      rating: 5,
  ...
  const serviceFAQs = [
    {
      ...
      answer: 'Our personal styling begins with a detailed style quiz. Based on your preferences, our stylists curate 5-7 outfits specifically for you. You can try them at home and keep what you love.'
    },
    {
      question: 'What is your return policy?',
      answer: 'We offer a 30-day return policy for all items in original condition. Return shipping is free for all customers. Refunds are processed within 24 hours of receiving the returned items.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Orders can be modified within 1 hour of placement. Please contact our customer service team immediately for any changes. After 1 hour, orders enter our processing system and cannot be modified.'
    }
  ];
    ...
    >
        ...
        <div className={Style.heroContent}>
          <div className={Style.heroText}>
            ...
            <p className={Style.heroDescription}>
              At Stackly, we go beyond just selling clothes. We offer comprehensive fashion services 
              designed to enhance your style journey. From personalized styling to hassle-free returns, 
              we're committed to making your fashion experience exceptional.
            </p>
            <p className={Style.heroDescription}>
          ...
          <div className={Style.heroImage}>
            <img 
              ...
              onError={(e) => {
                e.target.src = 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=600&h=400&fit=crop';
              }}
            />
          </div>
        </div>
      ...
      <section className={Style.servicesShowcase}>
        <div className={Style.servicesContent}>
          ...
          <p className={Style.servicesSubtitle}>Designed to make your fashion journey seamless and enjoyable</p>
          
          <div className={Style.servicesGrid}>
            {mainServices.map((service, index) => (
              <div 
                key={service.id}
                className={`${Style.serviceCard} ${activeService === index ? Style.activeService : ''}`}
      ...
      <section className={Style.premiumSection}>
        <div className={Style.premiumContent}>
          ...
          <p className={Style.premiumSubtitle}>Elevate your style experience with our premium offerings</p>
          ...
          <div className={Style.premiumGrid}>
            {premiumServices.map((service) => (
              <div key={service.id} className={Style.premiumCard}>
                ...
                <p className={Style.premiumDescription}>{service.description}</p>
